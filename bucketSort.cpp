...
int main()
{
    cout << "\tTIEMPOS DE EJECUCIÓN DE BUCKET SORT" << endl << endl;
    ...
    clock_t t;
    t = clock();
    bucketSort(diez, n); //Ordena el arreglo con BUCKET SORT y toma el tiempo
    t = clock() - t;
    t = ((float)t)*1000;
    ...
    t = clock();
    bucketSort(cien, n);;//Ordena el arreglo con BUCKET SORT y toma el tiempo
    t = clock() - t;
    t = ((float)t)*1000;

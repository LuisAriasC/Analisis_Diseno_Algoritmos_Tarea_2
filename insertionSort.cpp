...
int main()
{
    cout << "\tTIEMPOS DE EJECUCIÓN DE INSERTION SORT" << endl << endl;
    ...
    clock_t t;
    t = clock();
    insertionSort(diez, n); //Ordena el arreglo con INSERTION SORT y toma el tiempo
    t = clock() - t;
    t = ((float)t)*1000;
    ...
    t = clock();
    insertionSort(cien, n);//Ordena el arreglo con INSERTION SORT y toma el tiempo
    t = clock() - t;
    t = ((float)t)*1000;
